...
class Parser(object):
    ...
    def parse(self, dataset, keras_model, minibatch_parse_func, eval_batch_size=5000):
        sentences = []
        sentence_id_to_idx = {}
        ...
        model = ModelWrapper(keras_model, self, dataset, sentence_id_to_idx)
        dependencies = minibatch_parse_func(sentences, model, eval_batch_size)
...
class ModelWrapper(object):
    def __init__(self, keras_model, parser, dataset, sentence_id_to_idx):
    ...
    def predict(self, partial_parses):
        ...
        pred = self.keras_model.predict(mb_x)
